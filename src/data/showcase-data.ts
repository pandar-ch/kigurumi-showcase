  ...
  items: [
    {
      ...
      images: [
        {
          id: "img-1-1",
          src: "https://images.unsplash.com/photo-1559715745-e1b33a271c8f?w=800&q=80",
      ...
      details: [
        {
          ...
          items: [
            { label: "Matière", value: "Polaire 100% polyester" },
            { label: "Taille", value: "M (165-175cm)" },
            { label: "Poids", value: "450g" },
          ],
        },
        {
          id: "detail-1-2",
          title: "Entretien",
          items: [
            { label: "Lavage", value: "30°C max" },
            { label: "Séchage", value: "À l'air libre" },
            { label: "Repassage", value: "Non recommandé" },
          ],
        },
      ],
    ...
    },
    {
      ...
      images: [
        ...
        {
          id: "img-2-2",
          src: "https://images.unsplash.com/photo-1596460107916-430662021049?w=800&q=80",
          alt: "Détails Totoro",
          position: 1,
        },
      ],
      details: [
        {
          ...
          title: "Caractéristiques",
          items: [
            { label: "Matière", value: "Flanelle douce" },
            { label: "Taille", value: "L (175-185cm)" },
            { label: "Couleur", value: "Gris / Beige" },
          ],
        },
        {
          id: "detail-2-2",
          title: "Provenance",
          items: [
            { label: "Licence", value: "Officielle Studio Ghibli" },
    ...
    },
    {
      ...
      images: [
        {
          id: "img-3-1",
          src: "https://images.unsplash.com/photo-1531747056220-2b10b1c8f0d4?w=800&q=80",
          alt: "Kigurumi Stitch",
          position: 0,
        },
      ],
      details: [
        {
          ...
          title: "Caractéristiques",
          items: [
            { label: "Matière", value: "Polaire légère" },
            { label: "Taille", value: "M (165-175cm)" },
            { label: "Couleur", value: "Bleu électrique" },
          ],
        },
      ],
